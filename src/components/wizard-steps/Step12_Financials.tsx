...
export default function Step12_Financials({
  inputClass,
  textareaClass,
}: Step12Props) {
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="space-y-8 border-t border-purple-100/90 pt-10">
        <section className="space-y-4">
          <h2 className="text-sm font-semibold text-slate-900">
            Section 23. Pay expenses caused by the abuse (restitution)
          </h2>
          <label className={supportLabelCardClass}>
            <input
              type="checkbox"
              ...
              className={supportCheckboxClass}
            />
            <span className="text-sm font-medium text-slate-800">
